...
var e = document.LoginForm.num.value;


		if(e.length<10 ) 
		{
		alert("mobile number must contain 10 digits only");
		            document.LoginForm.num.focus();
		return false;
		}
		
		if(e.length>10 ) 
		{
		alert("mobile number exceded 10 digits, must contain 10 digits only");
		            document.LoginForm.num.focus();
		return false;
		}
		...
		{
			alert("only INDIAN mobile number accepted which start with 9 , 8 , 7 , 6");
            document.LoginForm.num.focus();
			return false;
		}
...
$(document).ready(function()
		{SNbutton.init("mybtn",
				{fields:["aname","uname","area","add","mob"],enabletext:"submit"})
		})
*/
</script>
	...
	<div class="container" >
		...
		<div class=" collapse navbar-collapse " id="go">
			...
			<ul class="navbar-nav" id="navul">
				...
				<a href="help.jsp?source=profile_edit" class=" nav-link"><li class="nav-item ">HELP</li></a>
	...
	<div class="row">
			...
			<div class="leftside col-md-3" style="padding:0px;">
						...
						<ul class="navbar-nav">				
							...
							<a href="profile_edit.jsp" class="" style="border-left:3px solid black;font-weight:bold;background-image: linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.1));"><li class="">Edit Profile</li></a>
		...
		<div class="  rightside col-md-9" style="background-color:;">
				<form  name="LoginForm" onSubmit="return fu();" action="profile_edit_action.jsp" method="post">
					<table align=center id="y">
						...
						<tr>
								<td>Agent Name  &nbsp &nbsp &nbsp &nbsp</td>
								<td><input class="form-control" type="text" name="an" value="<%=aname%>" id="aname" required></td>
						</tr>		
						<tr>	
								<td>User Name  &nbsp &nbsp &nbsp &nbsp</td>
								<td><input class="form-control" type="text" name="un" value="<%=un%>" id="uname" readonly="readonly" required></td>
						</tr>
									
						
						<tr>	
								<td>Mobile number  &nbsp &nbsp &nbsp &nbsp</td>
								<td><input class="form-control" type="number" name="num" value="<%=mob%>" id="mob" required></td>
						</tr>
						<tr>	
								<td>Work Area</td>
								<td><input class="form-control" type="text" name="area" value="<%=area%>" id="area" required></td>
						</tr>
						<tr>	
								<td>Address</td>
								<td><input class="form-control" type="text" name="add" value="<%=add%>" id="add" required placeholder=" Address Should Include Area"></td>
						</tr>
						<tr>	
								<td>gender</td>
							...
							<tr>
								<td colspan="2"><br><input id="mybtn" type="submit" class="btn btn-block btn-success btn-sm" value="Save"></td>
							</tr>
